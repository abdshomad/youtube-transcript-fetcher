...
- **Status**: Implemented
- **Date**: 14 Nov 2025
- **Description**: Users can select a target language (e.g., Spanish, French, German) from a dropdown menu before generating a transcript. The Gemini API will then produce the transcript in the chosen language.

### FL016 - Key Topic & Concept Extraction
- **Status**: Implemented
- **Date**: 15 Nov 2025
